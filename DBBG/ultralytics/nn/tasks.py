...
# Three points for improvement in this study

from .modules.DSConv import C2f_DSConv
from .modules.Dyhead import Detect_dyhead
from ultralytics.nn.modules.DAttention import DAttentionBaseline as DAttention
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            args = [c1, c2, *args[1:]]
            if m in {BottleneckCSP, C1, C2, C2f, C2fAttn, C3, C3TR, C3Ghost, C3x, RepC3, C2f_DSConv,C2fCIB}:
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, Detect_dyhead,OBB, ImagePoolingAttn, v10Detect}:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, Detect_dyhead,WorldDetect, v10Detect)):
                return "detect"
